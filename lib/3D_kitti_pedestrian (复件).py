...
#             line = line.split(",")
#             number = int(line[0])-1
#             if number == int(setline.strip()):
#
#                 write = open("result/" + setline.strip() + ".txt","a")
#                 x1 = float(line[1])
#                 y1 = float(line[2])
#                 x2 = float(line[3])+x1
#                 y2 = float(line[4])+y1
...
for i in range(10):
    ...
    GT_boxes3D_corners = load_kitti_annotation(image_index[i])["boxes_corners"]
    ...
    # upground = scan[:, 2]> -1.63
    # scan_upground = scan[upground, :]
    ...
    for i in range(box_img.shape[0]):
        ...
        #print "point_img_can: ", point_img_can
        #print "point_can: ", point_can
