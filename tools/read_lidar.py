...
def point_cloud_2_top(points,
    ...
    for i, height in enumerate(np.arange(height_range[0], height_range[1], zres)):
        ...
        # take the max z value of each slice
        order = np.argsort(zi_points)
        xi_points = xi_points[order]
        yi_points = yi_points[order]
        zi_points = zi_points[order]
        ref_i = ref_i[order]
...
root_dir = "/home/jackqian/MV3D/data/KITTI/object/training"
