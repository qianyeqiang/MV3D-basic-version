...
if __name__ == '__main__':
    ...
    # imdb: < class 'datasets.kitti_mv3d.kitti_mv3d'>
    # network: < class 'networks.MV3D_test.MV3D_test'>
    # sess: < class 'tensorflow.python.client.session.Session'>
    # weights_filename: VGGnet_fast_rcnn_iter_35000.ckpt
